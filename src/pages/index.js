    ...
    <div className="space-y-20 sm:space-y-32 md:space-y-40 lg:space-y-44 overflow-hidden">
      ...
      <header className="relative z-10 max-w-screen-lg xl:max-w-screen-xl mx-auto">
        <div className="px-4 sm:px-6 md:px-8 mb-14 sm:mb-20 xl:mb-8">
          ...
          {/*</p>          */}
          <p className="max-w-screen-lg text-lg sm:text-2xl sm:leading-10 font-medium mb-10 sm:mb-11">
            Tailwind CSS 是一个功能类优先的 CSS 框架，它集成了诸如 <InlineCode>flex</InlineCode>,{' '}<InlineCode>pt-4</InlineCode>, <InlineCode>text-center</InlineCode> 和{' '}<InlineCode>rotate-90</InlineCode> 这样的的类，它们能直接在脚本标记语言中组合起来，构建出任何设计。
          </p>
            ...
            <blockquote>
              <Paragraph className="max-w-4xl mx-auto mb-6">
                ...
                <Widont>
                  ...
                  如果您能抑制住想吐槽的冲动，给它一个机会，我真的觉得您会怀疑您是怎么用其他方式来使用 CSS 的。
                </Widont>
              </Paragraph>
            </blockquote>
