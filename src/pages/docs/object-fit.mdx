---
title: "Object Fit"
description: "用于控制可替换元素的内容如何调整大小的功能类。"
---
...
要控制可替换元素的内容如何只在特定的断点处调整大小，可以在任何现有的 object fit 功能类前添加 `{screen}:` 前缀。例如，将类 `md:object-scale-down` 添加到元素中，将在中等尺寸及以上屏幕上应用 `object-scale-down` 功能。
