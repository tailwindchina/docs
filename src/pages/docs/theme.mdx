...
开箱即用，您的项目将自动继承 [默认主题配置] (https://github.com/tailwindlabs/tailwindcss/blob/v1/stubs/defaultConfig.stub.js#L5)中的值。如果您想自定义默认主题，您有几个不同的选项，取决于您的目标。
...
如果您想在默认主题中出于任何原因引用一个值，您可以从 `tailwindcss/defaultTheme` 中导入它。
