...
description: "用于同时控制项目如何在水平和垂直方向对齐的工具。"
---
...
要在特定的断点放置项目，可以在任何现有的 `place-items` 工具类前添加 `{screen}:` 前缀。例如，使用 `md:place-items-center` 来仅在中等尺寸及以上的屏幕应用 `place-items-center` 功能。
