...
title: 智能感知
description: 为 Visual Studio Code 用户准备的 TailwindCSS 智能感知工具。
---
...
- **语法高亮显示**：提供语法定义，以便正确突出显示 Tailwind 特征。
...
在 [GitHub](https://github.com/tailwindcss/intellisense) 上查看该项目以获得更多了解，或者现在就[将它安装到 Visual Studio Code](vscode:extension/bradlc.vscode-tailwindcss) 开始使用。