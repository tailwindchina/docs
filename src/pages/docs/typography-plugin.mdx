...
[@tailwindcss/typography 插件](https://github.com/tailwindcss/typography)添加了一组可定制的 `prose` 类，您可以用它为任何普通的 HTML 添加漂亮的排版默认值，就像您在解析 Markdown 后得到的输出，或者您从 CMS 中提取的内容。
